...
<body class="d-flex min-vh-100 align-items-center" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(images/background.jpg); background-size: cover;">
